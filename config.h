...
static const char *playpause[] = { "/usr/bin/mpc", "toggle",  NULL };
static const char *playnext[] = { "/usr/bin/mpc", "next", NULL };
static const char *playprevious[] = { "/usr/bin/mpc", "prev", NULL };
// static const char *brightnessup[] = { "/usr/bin/xbacklight", "-inc", "10", NULL };
// static const char *brightnessdown[] = { "/usr/bin/xbacklight", "-dec", "10", NULL };
